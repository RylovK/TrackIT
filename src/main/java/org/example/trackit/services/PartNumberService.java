...
public interface PartNumberService {
    ...
    /**
     * Finds a part number by its number.
     *
    ...
    /**
     * Creates a new part number.
     *
     * @param partNumberDTO the part number data to create
     * @return the created part number
     */
    PartNumberDTO createPartNumber(PartNumberDTO partNumberDTO);
